...
def test_parameter_sets_entry_points():
    ...
    entry_points = list(zero_dimension_comparison_sei.parameter_sets).sort()
    parameter_sets = Path("src/zero_dimension_comparison_sei/parameters/input/").glob("*.py")
...
def test_parameter_sets_entry_point_load():
    ...
    parameters = zero_dimension_comparison_sei.parameter_sets['Chen2020']
    # Loading parameter sets through the source file by dynamically loading Chen2020.py as a module
    spec = importlib.util.spec_from_file_location("Chen2020mod", "src/zero_dimension_comparison_sei/parameters/input/Chen2020.py")
...
def test_model_entry_points():
    ...
    entry_points = list(zero_dimension_comparison_sei.models).sort()
    models = Path("src/zero_dimension_comparison_sei/models/input/").glob("*.py")
...
def test_model_entry_point_load():
    ...
    # Loading parameter_sets through entry points
    model_instance = zero_dimension_comparison_sei.Model("SPM")
